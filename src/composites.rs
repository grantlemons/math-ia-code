...
pub fn composite_simple(subints: u16, a: f32, b: f32) -> (f32, f32) {
...
pub fn composite_established(subints: u16, a: f32, b: f32, threshold: f32) -> (f32, f32) {
    let subinterval_width = f32::abs(b - a) / subints as f32;
...
pub fn composite_complexity(subints: u16, a: f32, b: f32, threshold: f32) -> (f32, f32) {
    let subinterval_width = f32::abs(b - a) / subints as f32;
